        ...
        <div className="container px-4 py-5 px-md-5 text-center text-lg-start my-5">
          <div className="row gx-lg-5 align-items-center mb-5">
            ...
            >
              ...
              />
              <div className="card bg-glass" style={{width:416,marginTop:-65,marginLeft:150}}>
                  ...
                  <form onSubmit={handleSubmit}>
                    ...
                    <div data-mdb-input-init className="form-outline mb-4">
                      <input
                        ...
                        value={values.data?.student_name}
                        onChange={(e) =>
                          setValues({ student_name: e.target.value })
                        }
                      />
                    </div>
                    {/* /* email  */}
                    ...
                    <div data-mdb-input-init className="form-outline mb-4">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setValues({ stream: e.target.value })
                        }
                      />
                    </div>
                {/* City */}
